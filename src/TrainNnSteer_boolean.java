 ...
 */
public class TrainNnSteer_boolean {
    public static void main(String[] args) {
        ...
        MLDataSet trainingSet = EncogUtility.loadEGB2Memory(new File("./train_data/trainingset_steering_boolean") );
        ...
        EncogUtility.trainToError(network, trainingSet, 0.055);
        EncogDirectoryPersistence.saveObject(new File("./trained_models/steer_NN_bool"), network);
